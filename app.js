...
app.get("/api/whatbeatsrock/:item1/:item2", async (req, res) => {
    ...
    console.log("Someone requested something from the /whatbeatsrock/item1/:item2 route.")

    
    res.json({item1: item1, item2: item2, winner: winner, explanation: explanation})
})
